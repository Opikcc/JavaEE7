package javaeems.chapter12.primes.client;

import javax.swing.*;
import java.awt.event.*;
import java.util.concurrent.Future;
import javax.ejb.EJB;
import javaeems.chapter12.primes.PrimeCalculatorRemote;
...
public class PrimesWindow extends JFrame {
    ...
    public PrimesWindow() {
        try {
            String title = (String) InitialContext.doLookup("java:comp/env/window-title");
            this.setTitle(title);
        } catch (NamingException r) {
            // the entry was not found, or was incorrectly specified 
        ...
        Thread t = new Thread() {
            public void run() {
                ...
                if (prime > 0) {
                    ...
                    jpb.setString("Try a lower limit...");
                    setTitle("Calculator limit was exceeded"); 
                }
            }
